<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class="navbar-brand" href="home.jsp"><strong><span class="text-danger">TicketBook</span></strong></a>
	</div>

	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			<li><a href="${pageContext.request.contextPath}/profile">Register</a></li>
			<li><a href="${pageContext.request.contextPath}/list.jsp">List</a></li>
			<li><a href="${pageContext.request.contextPath}/check.jsp">Check</a></li>
